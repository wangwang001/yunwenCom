;(function() {//匿名函数，防止污染
	    ...
	    ;(function($, window, document, undefined) {
	        ...
	        var plugName = "faqrobot",
	            defaults = {
	                ...
	                khPic: '', //客户图标
	                kfHtml: [
	                    '<div class="MN_answer"><div class="MN_kfName">%robotName%</div><div class="MN_kfCtn"><i class="MN_kfTriangle1 MN_triangle"></i><i class="MN_kfTriangle2 MN_triangle"></i>%helloWord%</div><div class="MN_kftime">%formatDate%</div></div>',//欢迎语组合
	                    '<div class="MN_helpful"><span class="MN_yes">满意</span><span class="MN_no">不满意</span></div>',//是否满意组合
	                    '<div class="MN_answer" aId="%aId%" cluid="%cluid%"><div class="MN_kfName">%robotName%</div><div class="MN_kfCtn"><i class="MN_kfTriangle1 MN_triangle"></i><i class="MN_kfTriangle2 MN_triangle"></i>%ansCon%%gusListHtml%%relateListHtml%%commentHtml%</div><div class="MN_kftime">%formatDate%</div></div>'//回答组合
	                ],//客服结构(所有的属性和%xxx%都必须存在)
	                khHtml: '<div class="MN_ask"><div class="MN_khName">me</div><div class="MN_khCtn"><i class="MN_khTriangle1 MN_triangle"></i><i class="MN_khTriangle2 MN_triangle"></i>%askWord%</div><div class="MN_khtime">%formatDate%</div></div>',//客户结构
	            ...
	            robotHtml: function(data) {
	                ...
	                if(data.webConfig) {//欢迎语结构
						...
						if(!data.robotAnswer[0].relateList[0] && data.robotAnswer[0].gusList[0]) {
	                        ...
	                        if(gusList.length>0){
								gusListHtml= '<p>'+ (gusWords.ydWords || 'Would you like to ask the following questions? ') +'</p>';
							}
    ...
    ;MN(function() {//使能获取到加载完毕的DOM
        ...
        'border-top': '1px solid #ccc'
	    	...
	    	//发送按钮
	    	var $MN_sendBtn = MN('<div class="MN_sendBtn" id="MN_sendBtn">Send</div>').css({
