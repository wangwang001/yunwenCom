;(function() {//匿名函数，防止污染
    ...
    ;MN(function() {//使能获取到加载完毕的DOM
        ...
        //var $minichatCss = MN('<link rel="stylesheet" href="../css/minichat.css"/>').appendTo('head');
    	...
    	function minichatJs() {
	    	...
	    	//侧边栏
	    	var $MN_sideBar = MN('<div class="MN_sideBar"><img src="./minichat/images/sideBar3.gif" alt="智能客服" style="width:100%;"></div>').appendTo('body');
